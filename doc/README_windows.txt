...
After completing windows setup then run windows command line (cmd)
  cd daemon
  microCoind
You would need to create a configuration file microCoin.conf in the default
wallet directory. Grant access to microCoind.exe in anti-virus and firewall
...
microCoind backupwallet <destination_backup_file>
Then shutdown ppcoind by
microCoind stop
Start up the new microCoind (0.3.0).
