#############################################################################
# Makefile for building: microCoin
# Generated by qmake (2.01a) (Qt 4.8.5) on: la 12. huhti 14:45:42 2014
# Project:  microcoin-qt.pro
# Template: app
# Command: c:\Qt\4.8.5\bin\qmake.exe -o Makefile microcoin-qt.pro
#############################################################################
...
Makefile: microcoin-qt.pro  c:/Qt/4.8.5/mkspecs/win32-g++/qmake.conf c:/Qt/4.8.5/mkspecs/features/device_config.prf \
	...
	$(QMAKE) -o Makefile microcoin-qt.pro
